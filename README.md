...
[![pub package](https://img.shields.io/pub/v/online_offline.svg)](https://pub.dev/packages/online_offline)
...
Agrega `online_offline` a tu `pubspec.yaml`:

```yaml
dependencies:
  online_offline: ^1.0.0
```
